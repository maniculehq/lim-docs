...
This page covers everything you can do to a running iOS simulator instance once it's created and `ready`. For provisioning, see the [Quickstart](/quickstart). For builds, see [Build with remote Xcode](/ios/build-with-xcode).
