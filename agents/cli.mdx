...
The console's **Connect** modal (cable icon next to a running instance) also wraps this up as one-click MCP installers for Replit, Cursor, and Claude Code. See [MCP for controlling instances](/agents/mcp).
...
lim ios install-app ./MyApp.ipa                # local .ipa, or
